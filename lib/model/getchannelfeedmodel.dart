...
//
//     final getChannelFeedModel = getChannelFeedModelFromJson(jsonString);

import 'dart:convert';

GetChannelFeedModel getChannelFeedModelFromJson(String str) =>
    GetChannelFeedModel.fromJson(json.decode(str));

String getChannelFeedModelToJson(GetChannelFeedModel data) =>
    json.encode(data.toJson());

class GetChannelFeedModel {
  int? status;
  String? message;
  List<Result>? result;
  int? totalRows;
  ...
  factory GetChannelFeedModel.fromJson(Map<String, dynamic> json) =>
      GetChannelFeedModel(
        status: json["status"],

...
class GetMusicByCategoryWebState extends State<GetMusicByCategoryWeb> {
  ...
  @override
  void initState() {
    getMusicByCategoryProvider = Provider.of<GetMusicByCategoryProvider>(
      context,
      listen: false,
    );
    _fetchData(0);
              ...
              child: Padding(
                ...
                child: ResponsiveGridList(
                  ...
                  children: List.generate(
                    getmusicbycategoryprovider.musicList?.length ?? 0,
                    (index) {
                      return InkWell(
                        onTap: () {
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          createPlaylistDilog(
                            playlistId: getMusicByCategoryProvider.playlistId,
                          );
                        },
                        child: Container(
                          width: 160,
  ...
  Widget buildPlaylistItem() {
    log(
      "Playlist Lenght==>${getMusicByCategoryProvider.playlistData?.length ?? 0}",
    );
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    MyText(
                      color:
                          getMusicByCategoryProvider.playlistPosition ==
                                      index &&
                                  getMusicByCategoryProvider.isSelectPlaylist ==
                                      true
                              ? black
                              : white,

...
class GetMusicByLanguageWebState extends State<GetMusicByLanguageWeb> {
  ...
  @override
  void initState() {
    getMusicByLanguageProvider = Provider.of<GetMusicByLanguageProvider>(
      context,
      listen: false,
    );
    _fetchData(0);
              ...
              child: Padding(
                ...
                child: ResponsiveGridList(
                  ...
                  children: List.generate(
                    getmusicbylanguageprovider.musicList?.length ?? 0,
                    (index) {
                      return InkWell(
                        onTap: () {
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          createPlaylistDilog(
                            playlistId: getMusicByLanguageProvider.playlistId,
                          );
                        },
                        child: Container(
                          width: 160,
  ...
  Widget buildPlaylistItem() {
    log(
      "Playlist Lenght==>${getMusicByLanguageProvider.playlistData?.length ?? 0}",
    );
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    MyText(
                      color:
                          getMusicByLanguageProvider.playlistPosition ==
                                      index &&
                                  getMusicByLanguageProvider.isSelectPlaylist ==
                                      true
                              ? black
                              : white,

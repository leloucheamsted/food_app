...
class WebShortsState extends State<WebShorts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Utils.sidePanelWithBody(myWidget: buildLayout()),
    );
  }
  ...
  Widget _buildShortPageView() {
    return SizedBox(
      ...
      height: ((html.window.screen?.height as double) * 0.90),
          ...
          return Stack(
            children: [
              ...
              VideoScreen(
                ...
                videoUrl:
                    shortProvider.profileShortList?[index].content.toString() ??
                    "",
              ),
              upDownBtn(),
              /* Show Gift */
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyText(
                        color: white,
                        text: Utils.kmbGenerator(
                          shortProvider.profileShortList?[index].totalComment ??
                              0,
                        ),
                        multilanguage: false,
                        textalign: TextAlign.center,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyText(
                        ...
                        text: Utils.kmbGenerator(
                          int.parse(
                            shortProvider.watchlaterShortList?[index].totalLike
                                    .toString() ??
                                "",
                          ),
                        ),
            ...
            children: [
              ...
              VideoScreen(
                ...
                thumbnailImg:
                    ...
                    "",
                videoId:
                    shortProvider.searchModel.result?[index].id.toString() ??
                    "",
                videoUrl:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      MyText(
                        color: white,
                        text: Utils.kmbGenerator(
                          shortProvider.searchModel.result?[index].totalLike ??
                              0,
                        ),
                        multilanguage: false,
                        textalign: TextAlign.center,
              ...
              shortTitle(
                title:
                    shortProvider.searchModel.result?[index].title.toString() ??
                    "",
              ),
            ],
          );
          ...
          return Stack(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: colorPrimaryDark.withOpacity(0.50),
                  borderRadius: BorderRadius.circular(5),
                ),
              ),
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child:
                          (shortProvider.addcommentloading)
                              ? const SizedBox(
                                height: 20,
                                width: 20,
                                child: CircularProgressIndicator(
          ...
          return Container(
            ...
            child: Row(
              ...
              children: [
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: MyText(
                          color: white,
                          text:
                              shortProvider.replaycommentList?[index].comment
                                  .toString() ??
                              "",
                          fontsizeNormal: Dimens.textSmall,
                          fontsizeWeb: Dimens.textSmall,
                ...
                const SizedBox(width: 10),
                if (shortProvider.replaycommentList?[index].userId.toString() ==
                    Constant.userID)
              ...
              children: [
                ...
                Consumer2<ShortProvider, ProfileProvider>(
                  builder: (context, shortprovider, profileprovider, child) {
                    if (shortprovider.giftloading) {
                      return Expanded(child: Utils.pageLoader(context));
                    } else {
                      if (shortprovider.giftList != null &&
                          (shortprovider.giftList?.length ?? 0) > 0) {
                        return Expanded(
                          child: SingleChildScrollView(
                            scrollDirection: Axis.vertical,
                            padding: const EdgeInsets.all(20.0),
    ...
    return Positioned.fill(
      ...
      child: Align(
        ...
        child: Column(
          ...
          children: [upDownButton(type: "up"), upDownButton(type: "down")],
        ),
      ),
    );
  }

  Widget upDownButton({type}) {
    return InkWell(

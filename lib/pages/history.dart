            ...
            itemBuilder: (context, index) {
              return InkWell(
                ...
                child: Container(
                  ...
                  child: MyText(
                    color: historyprovider.tabindex == index ? black : white,
                    multilanguage: true,
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: MyNetworkImage(
                        ...
                        height: 55,
                        imagePath:
                            historyProvider.historyList?[index].portraitImg
                                .toString() ??
                            "",
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          MyText(
                            ...
                            text: Utils.timeAgoCustom(
                              DateTime.parse(
                                historyProvider.historyList?[index].createdAt ??
                                    "",
                              ),
                            ),
                            textalign: TextAlign.left,
        ...
        return Padding(
          ...
          child: Container(
            ...
            child: const Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                CustomWidget.roundrectborder(width: 140, height: 80),
                SizedBox(width: 10),
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      CustomWidget.roundrectborder(width: 200, height: 7),
                      SizedBox(height: 5),
                      CustomWidget.roundrectborder(width: 150, height: 7),
                      SizedBox(height: 5),
                      CustomWidget.roundrectborder(width: 100, height: 7),
                    ],
                  ),
                ),
              ],

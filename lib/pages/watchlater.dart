              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        watchlaterprovider.tabindex == index
                            ? colorAccent
                            : colorPrimary,
                  ...
                  child: MyText(
                    color: watchlaterprovider.tabindex == index ? black : white,
                    multilanguage: true,
                ...
                child: Column(
                  ...
                  children: [
                    MyText(
                      color: white,
                      text:
                          watchLaterProvider.contantList?[index].title
                              .toString() ??
                          "",
      ...
      onTap: () {
        AdHelper.showFullscreenAd(context, Constant.rewardAdType, () {
          playAudio(
            ...
            position: index,
            contentName:
                watchLaterProvider.contantList?[index].episode?[0].name
                    .toString() ??
                "",
            isBuy:
                watchLaterProvider.contantList?[index].isBuy.toString() ?? "",
          ...
          SizedBox(
            ...
            child: Stack(
              children: [
                ...
                Align(
                  alignment: Alignment.center,
                  child: MyImage(width: 35, height: 35, imagePath: "pause.png"),
                ),
                if (watchLaterProvider.position == index &&
                    watchLaterProvider.deleteWatchlaterloading)
                  const Align(
      ...
      child: Padding(
        ...
        child: ResponsiveGridList(
          ...
          children: List.generate(8, (index) {
            return const Column(
              children: [
                CustomWidget.roundrectborder(height: 150),
                SizedBox(height: 10),
                CustomWidget.roundrectborder(height: 6),
                CustomWidget.roundrectborder(height: 6),
              ],
            );
          }),

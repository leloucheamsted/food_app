...
class MarketPlaceDetail extends StatefulWidget {
  ...
  @override
  State<MarketPlaceDetail> createState() => MarketPlaceDetailState();
}

class MarketPlaceDetailState extends State<MarketPlaceDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<MarketPlaceDetailProvider>(
        builder: (context, feeddetailprovider, child) {
          if (feeddetailprovider.loading) {
            return shimmer();
          } else {
    ...
    return Column(
      ...
      children: [
        ...
        MyNetworkImage(
          ...
          fit: BoxFit.cover,
          imagePath:
              marketPlaceDetailProvider.marketPlaceDetailModel.result?[0].image
                  .toString() ??
              "",
        ),
        marketPlaceDetailProvider

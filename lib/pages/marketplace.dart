  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //           borderRadius: BorderRadius.circular(50), color: colorAccent),
        //       child: Row(
  ...
  Widget buildProducts() {
    return Consumer<MarketPlaceProvider>(
      builder: (context, marketplaceprovider, child) {
        printLog(
          "content lenght==>${marketplaceprovider.marketplaceList?.length ?? 0}",
        );
        ...
        return InkWell(
          onTap: () async {
            await Navigator.push(
              ...
              PageRouteBuilder(
                pageBuilder:
                    (context, animation1, animation2) => MarketPlaceDetail(
                      userImage:
          ...
          child: Column(
            ...
            children: [
              ...
              //             MarketPlaceDetail(
              //           userImage: marketPlaceProvider
              //                   .marketplaceList?[index].userImage
              //                   .toString() ??
              //               "",
              //           userName: marketPlaceProvider
              //                   .marketplaceList?[index].userName
              //                   .toString() ??
              //               "",
              //           postId: marketPlaceProvider.marketplaceList?[index].id
              //                   .toString() ??
              //               "",
              //           channelName: marketPlaceProvider
              //                   .marketplaceList?[index].userChannelName
              //                   .toString() ??
              //               "",
              //         ),
              //         transitionDuration: Duration.zero,
    ...
    return ResponsiveGridList(
      ...
      children: List.generate(10, (index) {
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            const CustomWidget.roundrectborder(height: 200),
            const SizedBox(height: 8),
